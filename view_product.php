...
&nbsp;&nbsp;<input name="Search" type="submit" class="my_button round blue   text-upper" value="Buscar">
 ...
 <form action="" method="get" name="limit_go">
    Registros por pagina<input name="limit" type="text" class="round my_text_box" id="search_limit" style="margin-left:5px;" value="<?php if(isset($_GET['limit'])) echo $_GET['limit']; else echo "10"; ?>" size="3" maxlength="3">
...
<input type="button" name="selectall" value="Seleccionar todo" class="my_button round blue   text-upper" onClick="checkAll()"  style="margin-left:5px;"/>
<input type="button" name="unselectall" value="Limpiar selección" class="my_button round blue   text-upper" onClick="uncheckAll()" style="margin-left:5px;" />
<input name="dsubmit" type="button" value="Eliminar seleccionadas" class="my_button round blue   text-upper" style="margin-left:5px;" onclick="return confirmDeleteSubmit()"/>
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$row['stock_name']."'"); echo $quantity; ?></td>
    ...
    <td>	<!--Descomentar <a href="update_stock.php?sid=<?php echo $row['id'];?>&table=stock_details&return=view_product.php"	class="table-actions-button ic-table-edit">
	</a> 
