...
<li><a href="view_supplier.php" class=" supplier-tab">Proovedores</a></li>
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="view_report.php">Ver Reportes</a></li>
				</ul>
			...
			<div class="side-content fr">
				...
				<?php
							...
							if($count==0)
							{
                                                            echo "<br><font color=red size=6px >Constraseña anterior incorrecta!</font>" ;
                                                        }else{
                                                            if(trim($_POST['new_pass'])==trim($_POST['confirm_pass'])){
                                                                ...
                                                                $db->query("update stock_user  SET password='$con' where username='$username'");
                                                                 echo "<br><font color=green size=6px >Contraseña cambiada!</font>" ;
                                                            }else{
                                                                 echo "<br><font color=red size=6px >Confirmacion de contraseña incorrecta</font>" ;
                                                            }
                                                        }
                                }
                                ?>		
				...
				<table style="width:600px; margin-left:50px; float:left;" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td> Contraseña Anterior</td><td><input type="password" name="old_pass" readonly="readonly"></td></tr>
                                  <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr>
                                      <td>Nueva Contraseña</td><td><input type="password" name="new_pass" readonly="readonly" ></td></tr>
                                      <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr>
                                      <td>Confirmar Contraseña</td><td><input type="password" name="confirm_pass" readonly="readonly"></td>
				  </tr>
                                  <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr> <tr><td>&nbsp;</td><td>&nbsp;</td></tr><tr></tr>
                                  <tr><td>
                        <input  class="button round blue image-right ic-add text-upper" type="submit" name="Submit" name="change_pass" value="Guardar">
                     </td><td>			
                     <input class="button round red   text-upper"  type="reset" name="Reset" value="Limpiar"> </td></tr>
