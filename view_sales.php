	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width ">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="view_sales.php" class="active-tab sales-tab">Salidas</a></li>
				...
				<li><a href="view_supplier.php" class=" supplier-tab">Provedores</a></li>
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="view_sales.php">Ver Salidas</a></li>
...
&nbsp;&nbsp;<input name="Search" type="submit" class="my_button round blue   text-upper" value="Buscar">
</form>
 <form action="" method="get" name="limit_go">
   Pagina por registro<input name="limit" type="text" class="round my_text_box" id="search_limit" style="margin-left:5px;" value="<?php if(isset($_GET['limit'])) echo $_GET['limit']; else echo "10"; ?>" size="3" maxlength="3">
    <input name="go"  type="button" value="Ir" class=" round blue my_button  text-upper" onclick="return confirmLimitSubmit()">
</form>
...
<input type="button" name="selectall" value="Seleccionar todos" class="my_button round blue   text-upper" onClick="checkAll()"  style="margin-left:5px;"/>
<input type="button" name="unselectall" value="Deseleccionar todos" class="my_button round blue   text-upper" onClick="uncheckAll()" style="margin-left:5px;" />
<input name="dsubmit" type="button" value="Eliminar seleccionado" class="my_button round blue   text-upper" style="margin-left:5px;" onclick="return confirmDeleteSubmit()"/>
