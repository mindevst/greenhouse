...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <p><strong>Agregar nueva categoria </strong> - Agregar nueva( Control +A)</p>
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><span class="man">*</span>Nombre:</td>
                      <td><input name="name"placeholder="Categoria" type="text" id="name" maxlength="200"  class="round default-width-input" value="<?php echo $name; ?>" /></td>
                    ...
                    <tr>
                      <td>Direccion</td>
                      <td><textarea name="address" placeholder="Descripción"cols="8" class="round full-width-textarea"><?php echo $address; ?></textarea></td>
